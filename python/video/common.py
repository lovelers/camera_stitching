...
#left_points         = np.array([[907, 286],[ 1076, 379], [907, 376], [1024, 291], [1024, 378]])
#right_points        = np.array([[ 32, 276],[ 278, 385], [ 32, 389], [209, 287], [210, 386]])
...
overlap_output    = data_dir + 'overylay/'
